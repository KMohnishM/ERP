...
from app.models.models import User, Student, Staff
...
def profile():
    if current_user.role == 'student':
        ...
        return render_template('auth/profile.html', title='Profile', user=current_user, profile=student)
    elif current_user.role == 'staff' or current_user.role == 'admin':
        staff = Staff.query.filter_by(user_id=current_user.id).first()
        return render_template('auth/profile.html', title='Profile', user=current_user, profile=staff)
